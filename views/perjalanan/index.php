	                 				...
	                 				<tbody>
	                 					<?php while($perjalanan = $data_perjalanan->fetch_object()) : ?>
	                 						<tr>
	                 							...
	                 							<td>
	                 								<a href="<?= base_url('perjalanan/ubah/' . $perjalanan->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
	                 								<a href="<?= base_url('perjalanan/hapus/' . $perjalanan->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
	                 							</td>
	                 						</tr>
	                 					<?php endwhile; ?>
	                 				</tbody>
