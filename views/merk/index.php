	                 				...
	                 				<tbody>
	                 					<?php while($merk = $data_merk->fetch_object()) : ?>
	                 						<tr>
	                 							...
	                 							<td><?= $merk->merk ?></td>
	                 							<td>
	                 								<a href="<?= base_url('merk/ubah/' . $merk->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
	                 								<a href="<?= base_url('merk/hapus/' . $merk->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
	                 							</td>
	                 						</tr>
	                 					<?php endwhile; ?>
	                 				</tbody>
